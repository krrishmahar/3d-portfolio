...
const FeedbackCard = ({ index, testimonial, name, designation, company, image }) => (
  ...
  className="bg-black-200 rounded-3xl xs:w-[320px] w-full padding">
...
const Feedbacks = () => {
  return <div className="mt-12 bg-black-100 rounded-[20px]">
    <div className="bg-tertiary rounded-2xl min-h-[300px] p-10">
      <motion.div variants={textVariant()}>
        <p className="section-sub-text">What others say</p>
        <h2 className="section-head-text">Testimonials.</h2>
      </motion.div>
    </div>
    <div className="-mt-20 pb-14 gap-7 flex flex-wrap paddingX">
...
const SectionFeedbacks = SectionWrapper(Feedbacks, "");
